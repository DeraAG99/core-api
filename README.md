...
graph TD
  ...
  C --> D[admin<br/>API key, IP whitelist, scope & rate limit management]
  C --> E[auth<br/>JWT-based authentication & authorization]

  A --> F[shared<br/>Common DTOs, utilities, and constants]
  ...
  I --> J[ConsumerJob<br/>Async jobs (PDF downloader via RabbitMQ)]
